        ...
        child: GridView.count(
          ...
          children: [
            ...
            _buildCategoryButton(
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => MeatAndDairyPage()),
              );
            }),
  ...
  Widget _buildFruitCard(BuildContext context, String name, String imagePath) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => AppleSellersPage()), // Navigate to AppleSellersPage
        );
      },
      child: Card(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          _buildAppleSellerCard('OPG Weiner', 'Spickovina', '5 € / kg', 'assets/blank-profile-image.jpg', 5),
          _buildAppleSellerCard('OPG Mikro Bušilica', 'Babina Guzica', '6 € / kg', 'assets/blank-profile-image.jpg', 2),
        ],
      ),
    );
  }

  Widget _buildAppleSellerCard(String opgName, String village, String price, String imagePath, int rating) {
    return Card(
      margin: EdgeInsets.all(16),
      child: ListTile(
        leading: Image.asset(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.star, color: const Color.fromARGB(255, 255, 218, 7), size: 20), // Star icon for rating
                SizedBox(width: 5),
